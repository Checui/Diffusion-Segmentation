...
class BRATSDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, x):
        ...
        for seqtype in self.seqtypes:
            ...
            number = os.path.basename(os.path.dirname(filedict['t1']))
        ...
        out_dict = {}
        if self.test_flag:
            path2 = './data/brats/dataset/test_labels/' + str(
                number) + '-label.nii.gz'
            # path2 = os.path.abspath(f'./data/brats/dataset/test_labels/{number}-label.nii.gz')
